    ...
    def checkLogin(self):
        ...
        try:
            ...
            with open('cookie', 'rb') as f:
                ...
                cookies = cookies.cookiejar_from_dict(pickle.load(f))
    ...
    def login_by_QR(self):
        ...
        try:
            ...
            urls = (
                ...
                'https://passport.jd.com/new/login.aspx?ReturnUrl=http%3A%2F%2Fitem.jd.com%2F326467.html',
            ...
            logger.info('---'.join(['response.cookies: ', str(response.cookies)]))
...
def send_email(subject, message):
    try:
        my_sender = config.my_sender  # 邮件发送者
        my_pass = config.my_pass  # 邮件发送者邮箱密码
...
if __name__ == '__main__':
    ...
    options.count = 1
    options.good = '326467'
    options.area = '19_1607_40152_47420'
    options.timer = ""
